...
if (isset($_POST['adultDrug-btn'])){

    $tablet_name=$_POST['search'];
    $query= "SELECT * FROM adults_chemisttb WHERE  tbname='$tablet_name'";
    $result=mysqli_query($con,$query);

    echo "<div class='container' style='margin-top: 20px';>
 <img src='images/doc3.jpg' class='card-img-top' >
<div class='card'>
<div class='card-body'><a href='AdultsPharmacy.php' class='btn btn-light'>Go Back</a></div>
