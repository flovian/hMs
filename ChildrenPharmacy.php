...
<div class="card-body" style="background-color: #3498DB;color:#ffffff;">
    ...
    <div class="row" >
        ...
        <div class="col-md-3">
        <a href="AdultsPharmacy.php"class="btn btn-outline-light"><h9>View Adults Pharmacy</h9></a>
    </div>

        <div class="col-md-6">
            <form class="form-group" action="searchChildDrug.php" method="post">
                <div class="row">
                    <div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Enter name">
                    </div>
                    <div class="col-md-2"><input type="submit" name="childDrug-btn" class="btn btn-light" value="Search">
                    </div>
                </div>
            </form>
        </div>
